(function() {
  var SPECIAL_CSS_FILE_NAME, address, config, cssFile, currentFile, fs, lessFile, lines, name, outputCSSFile, outputFile, page, param, startTime, system, val, value, _i, _len, _ref, _ref2;
  ...
  page.onConfirm = function(fileName) {
    ...
    if (fileName === SPECIAL_CSS_FILE_NAME) {
      ...
      currentFile.name = SPECIAL_CSS_FILE_NAME;
    }
    currentFile.file = fs.open(fileName, 'w');
  ...
  page.open(encodeURI(address), function(status) {
    ...
    num = page.evaluate(function(lessFile, config, SPECIAL_CSS_FILE_NAME) {
